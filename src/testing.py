...
model_dir = r'D:\PYTHON DATA\Recomendador\src\results\checkpoint-171'
...
tokenizer = BertTokenizer.from_pretrained(r"D:\PYTHON DATA\Recomendador\src\results\checkpoint-171")
print("Tokenizador cargado con éxito.")

test_dataset = load_dataset('csv', data_files='D:/PYTHON DATA/Recomendador/dataset/cannabis_clean.csv')['train']
